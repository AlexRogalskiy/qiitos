...
***Txt2Json Converter*** is a tool to process input txt files with further json transformations.

## *Authors*

***Txt2Json Converter*** is maintained by the following GitHub team-members:
