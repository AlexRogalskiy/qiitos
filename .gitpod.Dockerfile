...
LABEL io.nullables.qiitos.build-date=$BUILD_DATE
LABEL io.nullables.qiitos.name="qiitos"
LABEL io.nullables.qiitos.description="TypeScript/Javascript CLI tools"
LABEL io.nullables.qiitos.url="https://nullables.io/"
LABEL io.nullables.qiitos.vcs-ref=$VCS_REF
LABEL io.nullables.qiitos.vcs-url="https://github.com/AlexRogalskiy/qiitos"
LABEL io.nullables.qiitos.vendor="Nullables.io"
LABEL io.nullables.qiitos.version=$VERSION
